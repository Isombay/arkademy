...
use arkademy;
create table product_categories(id int(5) primary key auto_increment not null, name varchar(50) not null, created_date timestamp not null);
create table products(id int(5) primary key auto_increment not null, name varchar(50) not null, category_id int(5), created_date timestamp not null,FOREIGN KEY (category_id) REFERENCES product_categories(id));
