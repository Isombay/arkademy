<?php
	...
	Class conn
	{
		...
		{
			$this->conn = new mysqli('localhost', 'root', 'arts', 'arkademy');
		}
		...
		{
			$query = $this->conn->query("UPDATE products SET $set WHERE id = '$id'");
			return $query;
		}

		public function delete($value)
		{
			$query = $this->conn->query("DELETE FROM products WHERE id = '$value' ");
			return $query;
		}
  						...
  						<caption>List of products</caption>
							...
							<tbody>
								<form class='form-horizontal' role='form' method='POST'>
									<?php
										$data = $conn->select('products.id as id, products.name as name, product_categories.name as category, products.category_id', 'products INNER JOIN product_categories ON products.category_id = product_categories.id');
